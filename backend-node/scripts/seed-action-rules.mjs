...
const ACTION_RULES = [
  ...
  // ---- 抽象占位口径：技能/宝具类自定义行动（效果 GM 按原文现场裁决，引擎只管占行动力与记账） ----
  ['技能', 'all', null, null, 0, 0, 1, 0, 0, '（跟随目标）',
   null,
   '占位口径：需要消耗行动力的技能行动。动词「技能」+描述；判定/数值/魔力消耗由 GM 按技能原文裁决', 'GM 2026-09-11'],

  ['宝具', 'servant', null, null, 0, 0, 1, 0, 0, '（跟随目标）',
   null,
   '占位口径：需要消耗行动力的宝具行动。动词「宝具」+描述；判定/数值/魔力消耗由 GM 按宝具原文裁决', 'GM 2026-09-11'],
]
