  ...
  <section class="page-card upload-page">
    ...
    <div class="two-column">
      <div class="input-block">
        <!-- Excel 文件上传区域 -->
        <label class="block-label">角色卡 Excel 文件上传（推荐）</label>
        <div
        ...
        <div v-if="uploadMessage" class="upload-msg" :class="{ 'upload-err': uploadMessage.startsWith('解析失败') }">
          {{ uploadMessage }}
        ...
        <!-- 分割线 -->
        <div class="divider">
          <span class="divider-text">或者手动粘贴 .st 文本</span>
        </div>
